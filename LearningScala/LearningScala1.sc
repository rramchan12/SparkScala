object LearningScala1 {
  ...
  val hello: String = "Hola, Ravi!"               //> hello  : String = Hola, Ravi!
  println(hello)                                  //> Hola, Ravi!
  
  // Notice how Scala defines things backwards from other languages - you declare the
  // name, then the type.
  
  // VARIABLES are mutable
  var helloThere: String = hello                  //> helloThere  : String = Hola, Ravi!
  helloThere = hello + " There!"
  println(helloThere)                             //> Hola, Ravi! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Hola, Ravi!There!
  println(immutableHelloThere)                    //> Hola, Ravi!There!
  ...
  // Just write your code below here; any time you save the file it will automatically display the results!
   ...
   println(f"Twice Pi to three decimals ${piSinglePrecision*2}%.3f")
                                                  //> Twice Pi to three decimals 6.283
